...
function Contact_Info() {
    $labels = array(
        'name'               => _x( 'Contact_Info', 'post type general name'),
...
add_shortcode( 'display_homepage_Contact_Info', 'display_custom_post_type' );

function display_custom_post_type(){

    $string = '';
    $query = get_posts(array('post_type' => 'Contact_Info', 'posts_per_page' => 5));
    if( $query){
